 ...
 * @author guill
 */
public class ProfesorView extends javax.swing.JFrame implements Observer {
    ...
    public void setTextoAccion(String s){
        ButtonAccion.setText(s);
        if("Ingresar".equals(s)){
    ...
    private void initComponents() {
        ...
        LabelAccion.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        LabelAccion.setText("Datos del alumno");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(TFTelefono, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(23, 23, 23)
                                        .addComponent(TFCedula, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(11, 11, 11)
                        .addComponent(ButtonAccion)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Application.CONTENEDOR.setEnabled(true);
    ...
    public void update(Observable o, Object arg) {
        ...
        TFCedula.setText(model.getFilter().getCedula().getCedula());
        TFNombre.setText(model.getFilter().getNombre());
        TFTelefono.setText(model.getFilter().getTelefono());
        TFEmail.setText(model.getFilter().getCedula().getEmail());
    }
}
